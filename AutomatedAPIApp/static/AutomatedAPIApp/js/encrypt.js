...
function auto_api_custom_encrypt(msg_string) {
...
function auto_api_custom_decrypt(msg_string){
...
function tms_authtoken(){
    return auto_api_custom_encrypt(get_tms_cookie("tms_session_id")+":"+tms_request_id()+":"+document.cookie);
}

exports.generate_random_string = generate_random_string
exports.auto_api_custom_encrypt = auto_api_custom_encrypt;
exports.auto_api_custom_decrypt = auto_api_custom_decrypt;
