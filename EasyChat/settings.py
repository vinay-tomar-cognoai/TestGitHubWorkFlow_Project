...
IS_REPORT_GENERATION_VIA_KAFKA_ENABLED = False
...
CRONJOBS = [
    ...
    ('*/5 * * * *', 'cronjob_scripts.easychat_analytics_export.cronjob'),
    ('* * * * *', 'cronjob_scripts.whatsapp_campaign_trigger_cronjob.cronjob'),
    ('*/15 * * * *', 'cronjob_scripts.campaign_analytics_update_cronjob.cronjob'),
    # ('* * * * *', 'cronjob_scripts.rcs_campaign_trigger_cronjob.cronjob'),
    ('0 19 * * *', 'cronjob_scripts.livechat_combined_cronjob.cronjob'),
    ('30 19 * * *', 'cronjob_scripts.easychat_combined_cronjob.cronjob'),
    ...
    ('30 23 * * *', 'cronjob_scripts.easychat_twitter_tracker.cronjob'),
]
