...
function append_bot_text_response(text_response, agent_name = null,time = null){
            if(time == null)
              var time = return_time();

        if (agent_to_customer_cobrowsing == "True"){
            var html = '<div class="easychat-bot-message-div"><div class="easychat-bot-message" style="color: ' + BOT_MESSAGE_COLOR + ';"><div class="easychat-bot-message-name">User: Customer</div><div class="easychat-bot-message-line"><div class="easychat-show-less-text">' + text_response + '</div></div>';
            ...
            var html = '<div class="easychat-bot-message-div"><div class="easychat-bot-message" style="color: ' + BOT_MESSAGE_COLOR + ';"><div class="easychat-bot-message-name">Agent: ' + agent_name + '</div><div class="easychat-bot-message-line"><div class="easychat-show-less-text">' + text_response + '</div></div>';
            html += '<div class=view_more_wrapper style="margin-right:5px;display:none "><div style="float:right;cursor: pointer;" onclick="viewMore(this)">View More<i class="fa fa-chevron-down" style="color:' + BOT_THEME_COLOR + ';margin-left:5px"></i></div></div></div>';
            html+='<span class="message-time-bot">' + time + '</span></div>';
        }
...
function send_user_input(user_input){
    ...
    if (agent_to_customer_cobrowsing == "True"){
        document.getElementById("easychat-chat-container").innerHTML += '<div class="easychat-user-message-div"><div class="easychat-user-message" style="background-color:' + BOT_THEME_COLOR + ';color: ' + USER_MESSAGE_COLOR + '"><div class="easychat-user-message-name">User: Agent</div><div class="easychat-user-message-line">'+ user_input + '</div></div><span class="message-time-user">' + time + '</span></div>';
    }else{    
        document.getElementById("easychat-chat-container").innerHTML += '<div class="easychat-user-message-div"><div class="easychat-user-message" style="background-color:' + BOT_THEME_COLOR + ';color: ' + USER_MESSAGE_COLOR + '"><div class="easychat-user-message-name">User: ' + client_name + '</div><div class="easychat-user-message-line">'+ user_input + '</div></div><span class="message-time-user">' + time + '</span></div>';
    }
...
function FeedbackModal(el){
    var temp_value = document.getElementsByClassName("circle-value")
    document.getElementById("easychat-exit-app-feedback").style.display = "none";
    for(var i=0; i<temp_value.length;i++){temp_value[i].style.strokeWidth= "1.5em"}
    el.style.strokeWidth= "2em"
    contentvalue = parseInt(el.getAttribute("value"))
    if(contentvalue < 10){document.getElementById("value-0"+el.getAttribute("value")).style.strokeWidth= "2em"}
    else{document.getElementById("value-"+el.getAttribute("value")).style.strokeWidth= "2em"}
...
function handle_parent_message(event) {
    ...
    if("show_agent_message" in data) {
        if(data.attachment != null) {
            ...
            var html = '<div class = "easychat-user-message-div"><div class = "easychat-bot-attachment"><table><tr><td><div class = "easychat-user-attachment-logo"><img src = ' + src + ' width = "30" height = "30"></div></td><td><div class = "easychat-user-attachment-name"> ' + data.attachment_file_name + '</div></td><td><div class ="easychat-user-download-attachment"><a href="' + data.attachment + '?session_id=' + session_id + '" target="_blank"><img src="/static/EasyAssistSalesforceApp/icons/download.svg"></a></div></td></tr></table></div><span class="message-time-bot">' + time + '</span></div>'
            document.getElementById("easychat-chat-container").innerHTML += html;
        }
        if(data.message != null && data.message.trim() != "") {
            append_bot_text_response(data.message, data.agent_name,time);
        }
    }
        ...
        if(data.attachment != null) {
            ...
            if(extension == 'pdf')
              ...
              src = "/static/EasyAssistSalesforceApp/icons/Image_Icon.svg";
            var html = '<div class = "easychat-user-message-div"><div class = "easychat-user-attachment"><table><tr><td><div class = "easychat-user-attachment-logo"><img src = ' + src + ' width = "30" height = "30"></div></td><td><div class = "easychat-user-attachment-name"> ' + data.attachment_file_name + '</div></td><td><div class ="easychat-user-download-attachment"><a href="' + data.attachment + '?session_id=' + session_id +  '" target="_blank"><img src="/static/EasyAssistSalesforceApp/icons/download.svg"></a></div></td></tr></table></div><span class="message-time-user">' + time + '</span></div>'
            document.getElementById("easychat-chat-container").innerHTML += html;
        }
        if(data.message != null && data.message.trim() != "") {
            document.getElementById("easychat-chat-container").innerHTML += '<div class="easychat-user-message-div"><div class="easychat-user-message" style="background-color:' + BOT_THEME_COLOR + ';color: ' + USER_MESSAGE_COLOR + '"><div class="easychat-user-message-name">User: ' + data.client_name + '</div><div class="easychat-user-message-line">'+ data.message + '</div></div><span class="message-time-user">' + time + '</span></div>';
...
function getBase64(file) {
    ...
    reader.onload = function() {
        ...
        var xhttp = new XMLHttpRequest();
        xhttp.open("POST", window.location.protocol + "//" + window.location.host + "/easy-assist-salesforce/agent/save-document/", true);
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(response["status"]==200){
                    ...
                    document.getElementById("send-document-button").style.display = "block";
                    ...
                    document.getElementById("send-document-error").innerHTML = "Unable to upload the document";
                    document.getElementById("send-document-error").style.color = "red";
                }
            }
        }
    ...
    reader.onerror = function(error) {
        ...
        document.getElementById("send-document-error").innerHTML = "Unable to read document file. Please upload valid document";
    };
}
...
function append_attachment_send_message(element){
    ...
    if(extension == 'pdf')
      ...
      src = "/static/EasyAssistSalesforceApp/icons/Image_Icon.svg";
    var html = '<div class = "easychat-user-message-div"><div class = "easychat-user-attachment"><table><tr><td><div class = "easychat-user-attachment-logo"><img src = ' + src + ' width = "30" height = "30"></div></td><td><div class = "easychat-user-attachment-name"> ' + attachment_file_name + '</div></td><td><div class ="easychat-user-download-attachment"><a href="' + attached_file_src + '?session_id=' + session_id +  '" target="_blank"><img src="/static/EasyAssistSalesforceApp/icons/download.svg"></a></div></td></tr></table></div><span class="message-time-user">' + time + '</span></div>'
    document.getElementById("easychat-chat-container").innerHTML += html;
    // var html = '<a href="' + attached_file_src + '" target="_blank"><img src="/static/EasyAssistSalesforceApp/img/documents2.png" style="height: 100%;width: 100%;border-radius: 1em;object-fit: contain;"></a>';
    ...
    if(attachment_message != null && attachment_message.trim() != "") {
        var time = return_time();
        document.getElementById("easychat-chat-container").innerHTML += '<div class="easychat-user-message-div"><div class="easychat-user-message" style="background-color:' + BOT_THEME_COLOR + ';color: ' + USER_MESSAGE_COLOR + '"><div class="easychat-user-message-name">User: '+ client_name + '</div><div class="easychat-user-message-line">'+ attachment_message + '</div></div><span class="message-time-user">' + time + '</span></div>';
    }
