"""
These are the HTMLs for creating the dynamic email UI. These variables is being used in utils_mailer_analytics.py 
"""
...
def get_email_company_head():
    ...
    <head>\
        ...
        .img-container, .img-container-word-cloud{\
            display: flex;\
            align-items: center;\
            margin: auto;\
        }\
        ...
        .img-container-word-cloud img{\
          max-width:100% !important;\
        }\
        .table-parameters-date-text{\
          display: inline;\
          margin: 0 5px;\
          color: #4d4d4d;\
          font-size: 10px;\
...
<table width="80%" align="center" cellpadding="0" cellspacing="0" border="0" dir="ltr" style="\
        background-color: rgb(242, 245, 247); margin-bottom: 15px;\
...
def get_email_company_logo():

    config_obj = get_developer_console_settings()

    BRAND_LOGO = settings.EASYCHAT_HOST_URL + config_obj.login_logo
    # general login logo is a svg and svg's are not supported in gmail so in that case sending default image
    ...
    EMAIL_COMPANY_LOGO = '\
      <tr>\
              <td align="center" valign="top" style="margin: 0; padding: 30px 15px 40px; background: linear-gradient(90deg,#' + PRIMARY_COLOR + ' 0%, #' + SECONDARY_COLOR + ' 100%,#' + SECONDARY_COLOR + ' 100%); border-radius: 8px 8px 0 0;">\
...
def get_email_footer():
    ...
    EMAIL_FOOTER = '\
      <tr style="background: linear-gradient(90deg,#' + PRIMARY_COLOR + ' 0%, #' + SECONDARY_COLOR + ' 100%,#' + SECONDARY_COLOR + ' 100%);">\
              <td height="40"></td>\
          </tr>\
            <tr style="background: linear-gradient(90deg,#' + PRIMARY_COLOR + ' 0%, #' + SECONDARY_COLOR + ' 100%,#' + SECONDARY_COLOR + ' 100%);">\
            ...
            <tr style="background: linear-gradient(90deg,#' + PRIMARY_COLOR + ' 0%, #' + SECONDARY_COLOR + ' 100%,#' + SECONDARY_COLOR + ' 100%); border-radius: 0 0 8px 8px;">\
...
EMAIL_ANALYTICS_START = "\
    <tr class='easychat-email-analytics-heading'>\
        <td class='easychat-mailer-table-heading'>\
            <p class='email-analytics-heading-p-first'>Here's usage analytics for your BOT {} </p>\
...
EMAIL_TABLE_PARAMERTERS_VALUES_BOLD = '\
    ...
    <tr style="background: white;">\
          <td align="left" valign="top">\
            <div class="easychat-mailer-download-reports-div">\
              ...
              <div class="easychat-mailer-download-reports-btn-div" style="text-align: center;">\
'
