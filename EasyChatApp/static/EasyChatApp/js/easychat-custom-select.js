/***************** EasyChat Custom Select ***********************/

class EasyChatCustomSelect {
    constructor(selector, placeholder, background_color) {
        ...
        document.addEventListener('click', function(e) {
            if(e.target == custom_dropdown_selected_option_wrapper) {
                ...
                custom_dropdown_selected_option_wrapper.classList.toggle('campaign-active-dropdown');
                ...
                custom_dropdown_selected_option_wrapper.classList.remove('campaign-active-dropdown');
            }
        });
