(function($) {
    ...
    function MultiSelect(element, options) {
        ...
        this.listNumber = generateRandomString(3);
    ...
    MultiSelect.prototype = {
        ...
        _updatePlaceholderText: function() {
            ...
            else if (true || (placeholderTxt.width() > placeholder.width()) || (selOpts.length != selectVals.length)) {
    ...
    // Custom Intents Multipl Select
    $.fn.multiselect_custom_intents = function(options) {
        if (!this.length) {
            return;
        }
