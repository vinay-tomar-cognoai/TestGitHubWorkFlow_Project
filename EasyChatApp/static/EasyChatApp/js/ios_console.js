function save_ios_theme_settings(element) {
    update_bot_color_font()
    check_theme_change = true
    $("#save-ios-channel").click();
}
...
function save_bot_font(font, font_size) {
    ...
    $.ajax({
        ...
        error: function(error) {
            document.getElementById("easychat_ios_channel_preloader").style.display = "none";
...
json_string = EncryptVariable(json_string)
document.getElementById("easychat_ios_channel_preloader").style.display = "block";
$.ajax({
    url: "/chat/channels/ios/edit/",
    type: "POST",
    data: {
        json_string: json_string
    },
...
$(document).on("click", "#save-ios-channel", function(e) {
...
add_channel_language_selction_event("ios")
...
$(document).on("click", "#save-ios-channel-for-non-primary-language", function(e) {
    let bot_id = (get_url_vars()["id"])
