...
function create_new_field(){
    let md5_string = get_md5_string(this);
    let create_field_modal_element = document.getElementById("modal-create-field-easyassist");
...
function submit_to_create_new_form_easyassist(){
    ...
    let form_name_element = document.getElementById("easyassist-new-form-name");
    ...
    let form_confirm_message_element = document.getElementById("easyassist-new-form-confirmation-message");
...
function submit_to_create_new_field_easyassist(element){
    ...
    let field_name_element = document.getElementById("easyassist-new-field-name");
    ...
    let field_is_masked = document.getElementById("easyassist-new-field-is-masked").checked;

    let field_group_number_element = document.getElementById("easyassist-new-field-group-number");
...
function close_easyassist_modal(){
    let easyassist_modal_list = document.getElementsByClassName("easyassist-modal");
