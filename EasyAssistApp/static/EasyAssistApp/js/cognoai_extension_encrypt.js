...
function cognoai_generate_random_string(length) {
   var result           = '';
...
function cognoai_custom_encrypt(msg_string) {
    // msgString is expected to be Utf8 encoded
    var key = cognoai_generate_random_string(16);
...
function cognoai_custom_decrypt(msg_string){
...
function easyassist_authtoken(){
    return custom_encrypt(get_easyassist_cookie("easyassist_session_id")+":"+easyassist_request_id()+":"+document.cookie);
}

exports.cognoai_generate_random_string = cognoai_generate_random_string
exports.cognoai_custom_encrypt = cognoai_custom_encrypt;
exports.cognoai_custom_decrypt = cognoai_custom_decrypt;
