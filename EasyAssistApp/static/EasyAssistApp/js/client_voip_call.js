...
function add_event_listeners() {
    ...
    jitsi_meet_api.addEventListener("videoConferenceLeft", function(e) {
        ...
        setTimeout(redirect_end_meeting_page, 200);
    });
}

function redirect_end_meeting_page() {
    window.location = "/easy-assist/voip-meeting-ended/client/" + meeting_id;
}
...
function easyassit_send_meeting_ended_over_socket() {
