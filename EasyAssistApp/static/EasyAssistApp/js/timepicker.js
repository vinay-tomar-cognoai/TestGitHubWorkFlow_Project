        ...
        function init(timeInputs) {
                ...
                setTimeout(function () {
                    ...
                    function timeClick() {
                        ...
                        function setTime() {
                            ...
                            let timeObj = convert24hrToNormal(timeIn24hr),
                                hour = timeObj.hour,
                                minute = timeObj.minute,
                                meridian = timeObj.meridian;
                                $('.nj-timepick-input--active').val(`${hour}:${minute} ${meridian}`);
                        }
                    }
            ...
            function timeInputClickEvent(timeInput) {
                timeInput.on('click', function () {
                    ...
                    popup.css({top : `${top_position + input_height + 15 }px`,left: `${left_position}px`}) 
