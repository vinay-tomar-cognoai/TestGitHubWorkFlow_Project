                        ...
                        '<div class="card-body">',
                            '<div class="row">',
                                '<div class="col-md-9 col-sm-12">',
                                    ...
                                    '</div>',
                                '</div>',
                                '<div class="col-md-3 col-sm-12 text-right mt-sm padding-sm" style="padding: 0">',
...
function remove_existing_form_category_question(question_id) {
    ...
    xhttp.open("POST", "/easy-assist/sales-ai/delete-cobrowse-form-category-question/", true);
...
function delete_existing_form_category(category_id) {
    ...
    const params = JSON.stringify(encrypted_data);
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "/easy-assist/sales-ai/delete-cobrowse-form-category/", true);
    xhttp.setRequestHeader('Content-Type', 'application/json');
    xhttp.setRequestHeader('X-CSRFToken', get_csrfmiddlewaretoken());
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
...
function create_form(el) {
    ...
    const params = JSON.stringify(encrypted_data);
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "/easy-assist/sales-ai/create-cobrowse-form/", true);
    xhttp.setRequestHeader('Content-Type', 'application/json');
    xhttp.setRequestHeader('X-CSRFToken', get_csrfmiddlewaretoken());
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
...
function save_form(el) {
    ...
    const params = JSON.stringify(encrypted_data);
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "/easy-assist/sales-ai/save-cobrowse-form/", true);
    xhttp.setRequestHeader('Content-Type', 'application/json');
    xhttp.setRequestHeader('X-CSRFToken', get_csrfmiddlewaretoken());
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
