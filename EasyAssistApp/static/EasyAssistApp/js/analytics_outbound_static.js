	...
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			if (response["status"] == 200) {
				...
				total_sr_customer_denied_list=[5, 5, 3, 4, 3, 6, 5, 3]
				total_sr_lead_captured_list=[45, 65, 30, 35, 50, 75, 60, 40]
				min_messages = 20;
				max_messages = 75;
	...
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			if (response.status == 200) {
				...
				agent_nps_analytics_list = [{"nps":78, "agent": "agent1"}, {"nps":69, "agent": "agent2"}, {"nps":89, "agent": "agent3"}, {"nps":90, "agent": "agent4"}];
	...
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			if (response.status == 200) {
				...
				query_pages = [{"title":"Apply for education loan", "total": 50}, {"title":"Open current account", "total": 150}, {"title":"Open saving account", "total": 100}];
