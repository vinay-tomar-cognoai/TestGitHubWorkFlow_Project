    ...
    constructor(select_element, placeholder, background_color, obfuscated_field) {
        ...
        try {
            if(!(select_element instanceof HTMLElement)) {
                let select_element = document.querySelector(selector);
            }
        } catch(err) {}
        ...
        custom_dropdown_selected_option_wrapper.addEventListener('click', function(e) {
            ...
            if(option_container_exist == false) {
                ...
                for(let idx = 0; idx < select_element.children.length; idx ++) {
                    ...
                    if(option_el.selected) {
                        if(is_obfuscated[0] == false) {
                            custom_dropdown_options += '<li  class="' + selected_list_class + '">';
                        } else {
                            custom_dropdown_options += '<li  class="' + selected_list_class + '" easyassist-obfuscate="' + is_obfuscated[1] + '">';
                        }
                        custom_dropdown_options += [
                            option_text,
                        ...
                        if(is_obfuscated[0] == false) {
                            custom_dropdown_options += '<li>';
                        } else {
                            custom_dropdown_options += '<li easyassist-obfuscate="' + is_obfuscated[1] + '">';
                        }
                        custom_dropdown_options += [
                            option_text,
                                '<input type="hidden" value="' + option_value + '">',
