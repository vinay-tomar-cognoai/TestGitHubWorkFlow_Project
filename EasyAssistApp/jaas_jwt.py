...
class JaaSJwtBuilder:
    ...
    def withModerator(self, isModerator):
        ...
        """
        self.userClaims[
            'moderator'] = 'true' if isModerator == True else 'false'
        return self
    ...
    def withLiveStreamingEnabled(self, isEnabled):
        ...
        """
        self.featureClaims[
            'livestreaming'] = 'true' if isEnabled == True else 'false'
        return self
    ...
    def withRecordingEnabled(self, isEnabled):
        ...
        """
        self.featureClaims[
            'recording'] = 'true' if isEnabled == True else 'false'
        return self
    ...
    def withTranscriptionEnabled(self, isEnabled):
        ...
        """
        self.featureClaims[
            'transcription'] = 'true' if isEnabled == True else 'false'
        return self
    ...
    def withOutboundCallEnabled(self, isEnabled):
        ...
        """
        self.featureClaims[
            'outbound-call'] = 'true' if isEnabled == True else 'false'
        return self
