...
function campaign_custom_encrypt(msg_string) {
...
function campaign_custom_decrypt(msg_string){
...
function campaign_authtoken(){
    return campaign_custom_encrypt(get_campaign_cookie("campaign_session_id")+":"+campaign_request_id()+":"+document.cookie);
}

exports.generate_random_string = generate_random_string
exports.campaign_custom_encrypt = campaign_custom_encrypt;
exports.campaign_custom_decrypt = campaign_custom_decrypt;
