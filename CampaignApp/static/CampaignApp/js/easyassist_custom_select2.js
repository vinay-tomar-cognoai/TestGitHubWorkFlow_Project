class EasyassistCustomSelect2 {
    constructor(select_element, placeholder, background_color) {
        ...
        custom_dropdown_selected_option_wrapper = create_element('div', 'easyassist-dropdown-selected2 selected-value-div');
        ...
        var dropdown_float_style = getComputedStyle(select_element).float;
        if(dropdown_float_style != "none") {
            custom_dropdown_wrapper.style.float = dropdown_float_style;
        }
        ...
        if(dropdown_option_selected!=true) {
            ...
            custom_dropdown_selected_option_wrapper.style.setProperty('color', "#cbcaca");
        } else {
            custom_dropdown_selected_option_wrapper.innerHTML = custom_dropdown_selected_option;
        }
        ...
        select_element.addEventListener('change', function(e) {
            try {
                var option_text = select_element.options[select_element.selectedIndex].innerHTML.trim();
                custom_dropdown_selected_option_wrapper.innerHTML = option_text;
                custom_dropdown_selected_option_wrapper.classList.add('variable-column-selected')
            } catch(err) {}
        });
        ...
        custom_dropdown_selected_option_wrapper.addEventListener('click', function(e) {
            ...
            if(custom_dropdown_option_container) {
                ...
                if(custom_dropdown_option_container_select_id == custom_dropdown_wrapper_id) {
                    ...
                    // custom_dropdown_option_container.style.top = select_element.parentElement.offsetHeight + 1 + "px";
                    // custom_dropdown_option_container.style.left = "0px";
            ...
            if(option_container_exist == false) {
                ...
                for(let idx = 0; idx < custom_dropdown_option_container.children.length; idx ++) {
                    ...
                    li_element.addEventListener('click', function(e) {
                        ...
                        custom_dropdown_option_container.classList.toggle(show_option_container_class);
                        custom_dropdown_selected_option_wrapper.classList.add('variable-column-selected')
                        custom_dropdown_selected_option_wrapper.classList.remove("active")
...
$(".custom_modal .modal-body").scroll(function() {
    if ($(this).scrollTop() > 0) {
      $('.easyassist-custom-dropdown-option-container2').removeClass("easyassist-dropdown-show2");
      $('.easyassist-dropdown-selected2.selected-value-div').removeClass('active')
    }
});