# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2021-04-22 07:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='logtailer.LogFile', verbose_name='log file')),
            ],
            options={
